...
void HAL_I2C_MspDeInit(I2C_HandleTypeDef* hi2c)
{
  ...
  /* USER CODE END I2C1_MspDeInit 0 */
    ...
    PB7     ------> I2C1_SDA
    */
    HAL_GPIO_DeInit(IMU1_SCL_GPIO_Port, IMU1_SCL_Pin);

    HAL_GPIO_DeInit(IMU1_SDA_GPIO_Port, IMU1_SDA_Pin);
  ...
  /* USER CODE END I2C2_MspDeInit 0 */
    ...
    PB3     ------> I2C2_SDA
    */
    HAL_GPIO_DeInit(IMU2_SCL_GPIO_Port, IMU2_SCL_Pin);

    HAL_GPIO_DeInit(IMU2_SDA_GPIO_Port, IMU2_SDA_Pin);
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* hspi)
{
  ...
  /* USER CODE END SPI2_MspDeInit 0 */
    ...
    PB15     ------> SPI2_MOSI
    */
    HAL_GPIO_DeInit(GPIOB, BMP_SCK_Pin|BMP_MISO_Pin|BMP_MOSI_Pin);
  ...
  /* USER CODE END SPI3_MspDeInit 0 */
    ...
    PB5     ------> SPI3_MOSI
    */
    HAL_GPIO_DeInit(GPIOB, NRF_SCK_Pin|NRF_MISO_Pin|NRF_MOSI_Pin);
